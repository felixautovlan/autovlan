...
class NetworkSegmentPlanner:
    ...
    def allocate(self, n_access: int, supernet: str, name_prefix: str) -> List[VLANSegment]:
        """Allocate VLANs and /24 subnets. Returns 2 infra VLANs + one data VLAN per access switch."""
        ...
        # Infrastructure VLANs — fixed IDs, always created first
        ...
        # One data VLAN per access switch, starting from FIRST_DATA_VLAN
